 ...
 */
  ...
  { 
    ...
    public function junglePlaced() {
        ...
        $x = self::getArg( "x", AT_int, true );
        $y = self::getArg( "y", AT_int, true );
        $this->game->junglePlaced( $jungle_id , $jungle_type , $card_id , $x , $y );
        self::ajaxResponse();
    }

    
    public function workerAndJunglePlaced() {
        self::setAjaxMode();
        $worker_id = self::getArg( "worker_id", AT_alphanum, true );
        $x = self::getArg( "x", AT_int, true );
        $y = self::getArg( "y", AT_int, true );
        $rotation = self::getArg( "rotation", AT_posint, true );
        $this->game->workerPlaced( $worker_id, $x, $y, $rotation );
        $jungle_id = self::getArg( "jungle_id", AT_alphanum, true );
        $jungle_type = self::getArg( "jungle_type", AT_alphanum, true );
        $card_id = self::getArg( "card_id", AT_int, true );
        $x = self::getArg( "jungle_x", AT_int, true );
        $y = self::getArg( "jungle_y", AT_int, true );
