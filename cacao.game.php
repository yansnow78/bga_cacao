...
//////////// 
    function confirmWorker( $tile_id , $this_x , $this_y , $rotation )
    {
        ...
        if ($junglePlaces != false) {
            ...
            */
            ...
            $this->workerPlaced($tile_id , $this_x , $this_y , $rotation);
    ...
    function workerPlaced( $tile_id , $this_x , $this_y , $rotation )
    {
        $player_id = self::getActivePlayerId();
        /*
    ...
    */
    function junglePlaced( $tile_id , $tile_type , $card_id , $place_x , $place_y ) {
